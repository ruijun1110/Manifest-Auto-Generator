...
/// 用于生成导出文件的模板类。
/// </summary>
public class YUEJIEORD : ManifestTemplate
{
    // 模板文件的路径。
    private const string _templateFilePath = "WanbXLSTemplates/美国/YUEJIE ORD Manifest-38ctns.xlsx";
    // 模版表头对应关系与默认值的json文件路径。（由于该模板有多个表单需要填写，因此需要分别指定。）
    private static readonly string[] _headersMatchingJson = new string[] { "TemplatesBinding/USTemplates/HeaderMatchings/YUEJIEORDW1.json", "TemplatesBinding/USTemplates/HeaderMatchings/YUEJIEORDW2.json" };

    public YUEJIEORD() : base()
    {
        TemplateName = "YUEJIE ORD Manifest-38ctns";
    }
