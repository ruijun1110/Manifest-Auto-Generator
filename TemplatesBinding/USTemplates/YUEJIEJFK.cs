...
/// 用于生成导出文件的模板类。
/// </summary>
public class YUEJIEJFK : ManifestTemplate
{
    // 模板文件的路径。
    private const string _templateFilePath = "WanbXLSTemplates/美国/YUEJIE JFK Manifest-38ctns.xlsx";
    // 模版表头对应关系与默认值的json文件路径。（由于该模板有多个表单需要填写，因此需要分别指定。）
    private static readonly string[] _headersMatchingJson = new string[] { "TemplatesBinding/USTemplates/HeaderMatchings/YUEJIEJFKW1.json", "TemplatesBinding/USTemplates/HeaderMatchings/YUEJIEJFKW2.json" };

    public YUEJIEJFK() : base()
    {
        TemplateName = "YUEJIE JFK Manifest-38ctns";
    }
